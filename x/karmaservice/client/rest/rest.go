...
func RegisterRoutes(cliCtx context.CLIContext, r *mux.Router, cdc *codec.Codec, storeName string) {
	r.HandleFunc(fmt.Sprintf("/%s/karma/{%s}", storeName, restName), getKarmaHandler(cdc, cliCtx, storeName)).Methods("GET")
...
func getKarmaHandler(cdc *codec.Codec, cliCtx context.CLIContext, addr string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		/*
			...
			// create the message
			msg := types.NewMsgSetKarma(0, addr)
